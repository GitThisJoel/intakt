\documentclass{article}
    ...
    \newcommand{\typ}{Swish}
    \newcommand{\datum}{2021-01-29}
    \newcommand{\summa}{9.0 kr}
    \newcommand{\namn}{Love Barany}
    \newcommand{\stilid}{lo5050ba-s}
    \newcommand{\beskrivning}{Försäljning av varor i Café}\newcommand{\fordelning}{3000 & Försäljning inom Sverige & 9.0\\}\newcommand{\varor}{choklad & 3000 & 1 & 9.0 & 9.0\\}\begin{document}
    \hspace{-0.3in}
